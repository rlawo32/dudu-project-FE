export const lightTheme = {
    bgColor: "#fdfaf7",
    reverseBgColor: "#121212",
    textColor: "#333333",
    reverseTextColor: "#DEDEDE",
    borderColor: "3px solid #333333",
    borderBottomColor: "1px solid rgba(0,0,0,0.1)",
    boxBgColor: "#DCDCDC",
    cardBgColor: "#faf9f7",
    noticeBgColor: "#f7f2ef",
    inputBgColor: "#f9f9f9",
    toggleColor: "#cbb5dc",
...
export const darkTheme = {
    bgColor: "#121212",
    reverseBgColor: "#f9f9f9",
    textColor: "#DEDEDE",
    reverseTextColor: "#333333",
    borderColor: "3px solid #2B2B2B",
    borderBottomColor: "1px solid rgba(255,255,255,0.1)",
    boxBgColor: "#2B2B2B",
    cardBgColor: "#3d3d3d",
    noticeBgColor: "#4f4d4d",
    inputBgColor: "#000000",
    toggleColor: "#e0cde3",
